        ...
        <div>
            <div className={style.firstSection}>
                <div className={style.left}>
                    <Image src={aboutImg} alt='About us' width={800} height={500} />
                    <div className={style.info}>
                        <p className={style.title}>Come and visit us</p>
                        <div className={style.part}>
                            <Image src={icon1} alt="Phone icon" width={24} height={24} />
                            <p>(414) 857 - 0107</p>
                        </div>
                        <div className={style.part}>
                            <Image src={icon2} alt="Email icon" width={24} height={24} className={style.mail} />
                            <p className={style.mail}>happytummy@restaurant.com</p>
                        </div>
                        <div className={style.part}>
                            <Image src={icon3} alt="Location icon" width={24} height={24} />
                ...
                <div className={style.right}>
                    ...
                    <p className={style.secondDopInf}>
            ...
            <div className={style.secondSection}>
                <div className={style.left}>
                    <p className={style.title}>A little information for our valuable guests</p>
                ...
                <div className={style.right}>
                    <Image src={aboutImg2} alt='Additional information' width={800} height={500} />
                </div>
            </div>
        </div>
    );
